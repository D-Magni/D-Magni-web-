        ...
        <div className="sidebar-wrapper">
          <nav id="sidebar">
            <ul className="list-none flex flex-col space-y-6 font-bold text-lg">
              <li className="my-2">
                <Link to="/dashboard" className="flex items-center text-white  hover:bg-white hover:text-gray-900 hover:p-1">
              ...
              <li className="my-2">
                <div className="group">
                  ...
                  <ul className="pl-4 mt-2 space-y-2 hidden group-hover:block">
                    <li>
                      <Link to="/admin/products" className="flex items-center text-white hover:bg-white hover:text-gray-900 hover:p-1">
                        <CategoryIcon className="mr-2" /> All
                      </Link>
                    </li>
                    <li>
                      <Link to="/admin/product" className="flex items-center text-white hover:bg-white hover:text-gray-900 hover:p-1">
              ...
              <li className="my-2">
                <Link to="/admin/orders" className="flex items-center text-white  hover:bg-white hover:text-gray-900 hover:p-1">
                  <ShoppingCart className="mr-2" /> Orders
                </Link>
              </li>
              <li className="my-2">
                <Link to="/admin/users" className="flex items-center text-white  hover:bg-white hover:text-gray-900 hover:p-1">
                  <PeopleIcon className="mr-2" /> Users
                </Link>
              </li>
              <li className="my-2">
                <Link to="/admin/reviews" className="flex items-center text-white  hover:bg-white hover:text-gray-900 hover:p-1">
